...
const XX99_MARK_ll = () => {
  ...
  useEffect(() => {
    dispatch({ type: "update_product_img", payload: XX99MARK2 });
    dispatch({ type: "update_product_product", payload: "XX99_MARK_II" });
    dispatch({ type: "update_product_cost", payload: 2999 });
  }, []);
  return (
    <main
      className={
    ...
    >
      <Product
        ...
        p3="The advanced Active Noise Cancellation with built-in equalizer allow you to experience your audio world on your terms. It lets you enjoy your audio in peace, but quickly interact with your surroundings when you need to. Combined with Bluetooth 5. 0 compliant connectivity and 17 hour battery life, the XX99 Mark II headphones gives you superior sound, cutting-edge technology, and a modern design aesthetic."
        b1="Headphone Unit"
      ...
      <div className="flex flex-col items-center md:mx-10 lg:mx-0 lg:w-3/4 lg:justify-center">
        <ImgGroup
          ...
          img2={itemstable}
          img3={headphoneclose}
          alt1="manwithheadphones"
          alt2="thingsontable"
          alt3="headphones close"
        />
      </div>
