    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <ProductLink
            mway="lg:mr-20"
            way="lg:flex-row-reverse"
            path="/zx7"
            isNew={false}
            img={zx7}
            h11="ZX7"
            h12="SPEAKER"
            p="Stream high quality sound wirelessly with minimal loss. The ZX7 bookshelf speaker uses high-end KS Elects components that represents the top of the line powered speakers for home or studio use."
          />
        </div>
