...
const ZX9 = () => {
  ...
  useEffect(() => {
    dispatch({ type: "update_product_img", payload: zx9 });
    dispatch({ type: "update_product_product", payload: "ZX9" });
    dispatch({ type: "update_product_cost", payload: 4500 });
  }, []);
  return (
    <main
      className={
    ...
    >
      <Product
        ...
        b3="User Manual"
        b4="3.5mm 10m Audio Cable"
        b5="10m Optical Cable"
        newp={newP}
        nr1="2x"
        nr2="2x"
        nr3="1x"
