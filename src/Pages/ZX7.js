...
const ZX7 = () => {
  ...
  useEffect(() => {
    dispatch({ type: "update_product_img", payload: zx7 });
    dispatch({ type: "update_product_product", payload: "ZX7" });
    dispatch({ type: "update_product_cost", payload: 3500 });
  }, []);
  ...
  return (
    ...
    >
      <Product
        ...
        h11="ZX7"
        h12="SPEAKER"
        p="Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end KS Elects components that represents the top of the line powered speakers for home or studio use."
        price="$ 3,500"
        ...
        b1="Speaker Unit"
        b2="Speaker Cloth Panel"
        b3="User Manual"
        b4="3.5mm 7.5m Audio Cable"
        b5="7.5m Optical Cable"
        newp={newP}
        nr1="2x"
        nr2="2x"
        nr3="1x"
      ...
      <div className="flex flex-col items-center lg:mx-0 lg:w-3/4 lg:justify-center">
        <ImgGroup
          img1={closespeakerblack}
          img2={speakerroom}
          img3={speakerontable}
          alt1="closespeakerblack"
          alt2="speakerroom"
          alt3="speakerontable"
        />
      </div>
